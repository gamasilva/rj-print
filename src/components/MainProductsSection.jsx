...
export default function MainProductsSection() {
  return (
    <section id="produtos" className="bg-white py-16 sm:py-24" aria-labelledby="main-products-heading">
          ...
          {productCategories.map((category, index) => {
            ...
            return (
              ...
              >
                {/* Imagem */}
                <div
                  className={`relative w-full aspect-[4/3] sm:aspect-video lg:aspect-square overflow-hidden rounded-2xl shadow-xl border border-gray-100 ${
                ...
                >
                  <h3 className="text-2xl font-black text-gray-900 sm:text-3xl mb-4">
                    {category.title}
                  </h3>
                  ...
                  <div className="mb-6 flex flex-wrap items-baseline gap-2 rounded-lg bg-gray-50 px-4 py-3 border border-gray-100 w-full sm:w-auto">
                    <span className="text-xs font-bold text-gray-500 uppercase tracking-widest">A partir de</span>
                    <span className="text-3xl font-black text-gray-900 tracking-tight">{category.startingPrice}</span>
                  </div>
