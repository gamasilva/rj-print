...
export default function HeroSection() {
  return (
    ...
    >
      ...
      {/* ═══════════════════════════════════════════════════
          MOBILE  (< lg) — impacto em 3 segundos
      ═══════════════════════════════════════════════════ */}
      <div className="relative z-10 flex min-h-[110svh] w-full flex-col justify-center overflow-hidden px-6 pb-[20vh] pt-12 text-center lg:hidden">
        ...
        {/* Wrapper do Conteúdo para ficar 100% ACIMA da logo */}
        <div className="relative z-10 flex w-full flex-col items-center">
          
          {/* Eyebrow — texto em vermelho forte */}
          <p className="mb-4 text-[11px] font-black uppercase tracking-[0.2em] text-[#FF2A2A] drop-shadow-sm">
            Preço de Distribuidor · Original de Fábrica
          </p>

          {/* Headline */}
          <h1 id="hero-heading" className="text-[2.8rem] font-black leading-[1.06] tracking-tight text-white">
            Tinta Original.<br />
          ...
          {/* Prova social rápida */}
          <p className="mx-auto mt-5 max-w-[260px] text-[15px] font-medium leading-snug text-white/75">
          ...
          <a
            ...
            className="mx-auto mt-10 flex w-full max-w-[300px] items-center justify-center gap-3 rounded-2xl bg-[#25D366] py-5 text-[17px] font-black uppercase tracking-wide text-white shadow-[0_8px_30px_rgba(37,211,102,0.6)] hover:bg-[#1ebd5a] active:scale-95 transition-all"
          >
            <svg className="h-6 w-6 shrink-0 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <p className="mt-4 text-[11px] font-bold text-white/50">
            Sem cadastro · Resposta em minutos
          </p>

          {/* 3 provas rápidas */}
          <div className="mx-auto mt-12 flex w-full max-w-[300px] justify-between">
            {[
              { n: "100%", l: "Original" },
              { n: "#1", l: "Menor Preço" },
              { n: "30d", l: "Garantia" },
              ...
              <div key={s.l} className="flex flex-col items-center gap-0.5">
                ...
                <span className="text-[10px] font-bold uppercase tracking-wide text-white/60">{s.l}</span>
              </div>
            ))}
          </div>
        </div>
