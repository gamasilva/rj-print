...
export default function AuthoritySection() {
  ...
  return (
    <section id="logistica" className="relative w-full py-16 sm:py-24 overflow-hidden">
      <div className="absolute top-0 right-0 w-96 max-w-[80vw] h-96 bg-theme-accent-light/10 blur-[120px] rounded-full pointer-events-none" aria-hidden="true" />
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-3">
          ...
          <div className="flex flex-col items-start text-left">
            ...
            <p className="text-base text-theme-text-muted leading-relaxed mb-5">
              Trabalhamos com transportadoras referência no mercado. Acompanhe seu pedido em tempo real, da nossa expedição até a sua porta, em todo o Brasil.
            </p>

            {/* Tags de confiança */}
            <div className="flex flex-wrap gap-2 mb-6">
              {["⚡ Rapidez", "🔒 Confiabilidade", "📍 Rastreamento em todo Brasil"].map((tag) => (
                <span key={tag} className="inline-flex items-center rounded-full border border-theme-border bg-theme-bg-glass px-3 py-1 text-xs font-semibold text-theme-text-secondary">
                  {tag}
                </span>
              ))}
            </div>
            ...
            {/* Transportadoras */}
            <p className="text-xs font-bold uppercase tracking-widest text-theme-text-muted mb-3">Parceiros de entrega</p>
            <div className="flex flex-wrap gap-2 sm:gap-3 w-full mt-2">
              <span className="inline-flex items-center rounded-lg bg-[#E05206] px-4 py-2 text-sm font-black text-white shadow-[0_4px_14px_0_rgba(224,82,6,0.39)] ring-1 ring-white/10 hover:-translate-y-0.5 transition-transform">
                União Transportes
              </span>
              <span className="inline-flex items-center rounded-lg bg-[#0046B8] px-4 py-2 text-sm font-black text-white shadow-[0_4px_14px_0_rgba(0,70,184,0.39)] ring-1 ring-white/10 hover:-translate-y-0.5 transition-transform">
                Buslog
              </span>
              <span className="inline-flex items-center rounded-lg bg-[#D11124] px-4 py-2 text-sm font-black text-white shadow-[0_4px_14px_0_rgba(209,17,36,0.39)] ring-1 ring-white/10 hover:-translate-y-0.5 transition-transform">
                Braspress
              </span>
            </div>
          </div>
