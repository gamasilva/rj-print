export default function SocialProofSection() {
  ...
  return (
    ...
    >
      <div className="absolute top-1/2 left-0 -translate-y-1/2 w-[20rem] max-w-[80vw] h-[20rem] bg-theme-accent-light/10 blur-[120px] rounded-full pointer-events-none" aria-hidden="true" />
